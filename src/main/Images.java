...
public class Images {
	...
	public static BufferedImage[] life_supply;
	...
	static{
		...
		//生命补给的加载
		life_supply = new BufferedImage[5];
		life_supply[0] = readImage("images\\life_supply.png");
		
		//爆破图片的加载
		supplys[1] = readImage("images\\bom1.png");
		bees[1] = readImage("images\\bom1.png");
		bom[1] = readImage("images\\bom1.png");
		life_supply[1] = readImage("images\\bom1.png");
		...
		life_supply[2] = readImage("images\\bom1.png");
		...
		life_supply[3] = readImage("images\\bom1.png");
		...
		life_supply[4] = readImage("images\\bom1.png");
