...
public class World extends JPanel implements Runnable,KeyListener {
	...
	static{
		start = Images.readImage("images\\again.png");
	...
	public void outOfBoundsAction(){
		int index = 0;
		Flying_Object[] fs = new Flying_Object[enemies.length];
		for(int i=0;i<enemies.length;i++){
			Flying_Object f = enemies[i];
	...
	public void paint(Graphics g){
		...
		g.drawString("BOMB:"+hero.getBomb(), 10,65);
